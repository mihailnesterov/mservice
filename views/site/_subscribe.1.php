        ...
        <div id="subscribe" class="container">
            <div class="row">
                ...
                <div class="col-xs-6 col-md-4 text-right">
                    <p>Получайте наши свежие новости <i class="fa fa-angle-double-right"></i></p>
                </div> <!-- end col -->
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            <?= $form->field($subscribe, 'email')
                                ->textInput(['type' => 'email', 'class' => 'form-control input-lg', 'placeholder' => 'Введите E-mail', 'id' => 'subscribe-field', 'required' => 'required'])
                                ->label(false) ?>
